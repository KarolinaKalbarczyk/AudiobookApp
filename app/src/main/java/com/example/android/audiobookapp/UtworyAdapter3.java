...
public class UtworyAdapter3 extends ArrayAdapter<com.example.android.audiobookapp.Utwory3>{

    public UtworyAdapter3(Context context, ArrayList<com.example.android.audiobookapp.Utwory3> utwory3) {
