...
public class UtworyAdapter5 extends ArrayAdapter<com.example.android.audiobookapp.Utwory5>{

    public UtworyAdapter5(Context context, ArrayList<com.example.android.audiobookapp.Utwory5> utwory5) {
