...
public class UtworyAdapter6 extends ArrayAdapter<com.example.android.audiobookapp.Utwory6>{

    public UtworyAdapter6(Context context, ArrayList<com.example.android.audiobookapp.Utwory6> utwory6) {
